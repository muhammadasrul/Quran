package com.acun.quran.ui.quran.share
...
import com.acun.quran.BuildConfig
import com.acun.quran.R
import com.acun.quran.databinding.FragmentShareBinding
import java.io.File
...
//        setSystemUIVisibility(false)
        ...
        binding.textViewTitle.text = if (args.surah?.name?.transliteration?.en == null) args.verse.surahName else args.surah?.name?.transliteration?.en
        ...
        binding.cardContainer.setOnClickListener {
            val startAnimation = ScaleAnimation(1f, .95f, 1f, .95f, Animation.RELATIVE_TO_SELF, .5f, Animation.RELATIVE_TO_SELF, .5f)
            startAnimation.duration = 200
            startAnimation.fillAfter = true
            binding.cardContainer.startAnimation(startAnimation)

            val endAnimation = ScaleAnimation(.95f, 1f, .95f,1f, Animation.RELATIVE_TO_SELF, .5f, Animation.RELATIVE_TO_SELF, .5f)
